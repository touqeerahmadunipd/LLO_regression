...
response_I <- generate_binary_response("II", X)
...
#save(df_combined , file = "space_dist_ex3.Rdata")
...
ggplot(df_combined, aes(x = method, y = x, group = d, color = d)) +
  ...
  labs(x = "Sample size", y = "Distance to CS", title = "Example 3") +
...
ggplot(df_MC, aes(x = method, y = x, group = d, color = d, linetype = d)) +
  ...
  geom_line(position = position_dodge(width = 0.1), size = 0.5) +
  labs(x = "Sample size", y = "Mislassification risk", title = "Example 3") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "top",
...
# 
# # setwd("D:/PostDoc work/Figures/classification/Simulation/code/Ex3")
# # save(df_AM, file = "AM_ex3.Rdata")
# # Plot
# 
# # Plot
# 
